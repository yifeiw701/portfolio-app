  ...
  return (
    <section id="skills">
      <div className="my-12 pb-12 md:pt-16 md:pb-48">
        ...
        <h1 className="space-y-5 md:space-y-10 px-0 md:px-12 text-2xl font-bold mb-6 mt-12">
        ...
        <div className="grid grid-cols-4 gap-4 md:gap-5 pl-4 pr-4 md:pl-10 md:pr-10">
          {skills.map((item, idx) => {
            return (
              ...
              >
                <p className="bg-gradient-to-r from-[#ff7e5f] to-[#feb47b] px-5 py-3 mr-2 mt-2 text-white rounded font-semibold shadow-lg">
                  {item.skill}
                </p>
              </motion.div>
            );
