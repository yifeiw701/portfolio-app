...
const Hero = () => {
  return (
    <section id="home">
      <div className="flex flex-col-reverse relative md:flex-row text-center items-center justify-center animate-fadeIn my-6 py-16 sm:py-32 md:py-48 md:px-8 md:space-x-4 lg:space-x-4 md:text-left">
